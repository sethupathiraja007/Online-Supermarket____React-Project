...
export default function Card2() {
  ...
  const keys = JSON.parse(sessionStorage.getItem("datajson3"));
  const [Data, setData] = useState(keys ? keys : datas.dol);
  sessionStorage.setItem("datajson3", JSON.stringify(Data));
      ...
      >
        <div class="spinner-grow  text-warning">
          <Link to="/cardloop">
            ...
            <button style={{ border: "none", outline: "0" }}>VEGETABLES</button>
          </Link>
        </div>
        <div class="spinner-grow  text-warning">
          <Link to="/fruitscard">
