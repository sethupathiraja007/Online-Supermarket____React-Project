...
export default function Card1() {
  ...
  const keys = JSON.parse(sessionStorage.getItem("datajson2"));
  const [Data, setData] = useState(keys ? keys : datas.rice);
  sessionStorage.setItem("datajson2", JSON.stringify(Data));
